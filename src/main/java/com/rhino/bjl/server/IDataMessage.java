...
public interface IDataMessage {
    ...
    List<HashMap<String,Object>> findReetListByMN(String jishu, String oushu, int start, int limit);

    int findReetListCountByMN(String jishu, String oushu, int start, int limit);

    List<HashMap<String,Object>> findReetByPai(String xian1, String xian2, String xian3, String zhuang1, String zhuang2, String zhuang3);
