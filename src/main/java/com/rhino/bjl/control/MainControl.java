...
public class MainControl extends BaseControl {
    ...
    public ResponseEntity<String> reetAllData(HttpServletRequest request) {
        ...
        String zhuang_1 = ParamUtils.getParameter(request, "zhuang_1", "");
        String zhuang_2 = ParamUtils.getParameter(request, "zhuang_2", "");
        String zhuang_3 = ParamUtils.getParameter(request, "zhuang_3", "");
        String xian_1 = ParamUtils.getParameter(request, "xian_1", "");
        String xian_2 = ParamUtils.getParameter(request, "xian_2", "");
        String xian_3 = ParamUtils.getParameter(request, "xian_3", "");
        String zhuangdianshu = ParamUtils.getParameter(request, "zhuangdianshu", "");
        String xiandianshu = ParamUtils.getParameter(request, "xiandianshu", "");
        List<HashMap<String, Object>> yhgl = mainMessage.findReetList(category,zhuang_1,zhuang_2,zhuang_3,xian_1,xian_2,xian_3,zhuangdianshu,xiandianshu,startDate,endDate,query ,start, limit);
        int count = mainMessage.findReetListCount(category,zhuang_1,zhuang_2,zhuang_3,xian_1,xian_2,xian_3,zhuangdianshu,xiandianshu,startDate,endDate,query ,start, limit);
        param.put("yhgl", yhgl);
