...
<body style="margin: 3px;">
    ...
    <!--大路-->
    <div style="position: absolute;left:10px;top:300px;width: 730px;overflow: auto;height: 182px;">
   ...
   -->
    ...
    <!--大眼仔-->
    <div style="position: absolute;left:10px;top:480px;width: 370px;overflow: auto;height: 150px;">
        <div style="width: 1480px;">
            <table class="table4">
                <%
                    for (int i=1; i<75;i++) {
    ...
    <!--小路-->
    <div style="position: absolute;left:380px;top:480px;width: 370px;overflow: auto;height: 150px;">
        <div style="width: 1480px;">
            <table class="table4">
                <%
                    for (int i=1; i<75;i++) {
    ...
    <!--蟑螂路-->
    <div style="position: absolute;left:750px;top:480px;width: 370px;overflow: auto;height: 150px;">
        <div style="width: 1480px;">
            <table class="table4">
                <%
                    for (int i=1; i<75;i++) {
