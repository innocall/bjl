Ext.onReady(function () {
    ...
    var jsonReetAnaly = new Ext.data.JsonStore({
        ...
        root: 'sreet',
        totalProperty: 'count',
        fields: ['ID','ROOMID','POINT','MNRESULTA','MNRESULTB','MNRESULTC','MNRESULTTYPE','MNRESULTAVALUE','VALUE','MNRESULTVALUE','TIME']
    });
